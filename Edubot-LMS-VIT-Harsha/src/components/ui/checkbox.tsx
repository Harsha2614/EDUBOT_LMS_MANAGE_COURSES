...
>(({ className, ...props }, ref) => (
  <CheckboxPrimitive.Root
    ref={ref}
    className={cn(
      "tw-peer tw-h-4 tw-w-4 tw-shrink-0 tw-rounded tw-border tw-border-input tw-ring-offset-background",
    ...
    {...props}
  >
    <CheckboxPrimitive.Indicator className="tw-flex tw-items-center tw-justify-center tw-text-current">
